...
The preferred way to report a vulnerability is through GitHub's [Private Vulnerability Reporting](https://docs.github.com/en/code-security/security-advisories/guidance-on-reporting-and-post-processing-security-vulnerabilities/privately-reporting-a-security-vulnerability). This allows you to report security issues directly to the maintainers in a secure and private manner.

To report a vulnerability:

1. On GitHub.com, navigate to the main page of the repository.
1. Under the repository name, click **Security**.
1. In the left sidebar, under "Reporting", click **Advisories**.
1. Click **Report a vulnerability**.

### Email

Alternatively, you can email me at **`matthewdeanmartin@gmail.com`**.
...
docker run --rm -v "$(pwd):/data" dedlin /data
```
